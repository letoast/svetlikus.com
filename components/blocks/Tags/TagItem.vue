...
<template>
	<div
		ref="cardRef"
		class="
			relative me-2 inline-flex items-center justify-center rounded bg-neutral-900 bg-[radial-gradient(var(--circle-size)_circle_at_var(--x)_var(--y),_theme(colors.purple.950)_0%,_theme(colors.purple.950)00_62.24%),linear-gradient(210deg,_theme(colors.neutral.900)_-2.85%,_#090909_100%)] px-3.5 py-[7px]
			before:absolute before:-left-px before:-top-px before:z-[-1] before:size-[calc(100%+2px)] before:rounded before:bg-[radial-gradient(var(--circle-size)_circle_at_var(--x)_var(--y),_theme(colors.purple.500)_0%,_theme(colors.neutral.300)00_62.24%),linear-gradient(149.04deg,_theme(colors.neutral.800)_13.47%,_theme(colors.neutral.800)00_62.24%)] before:transition-all before:duration-300
