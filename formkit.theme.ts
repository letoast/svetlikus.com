...
const classes: Record<string, Record<string, boolean>> = {
	...
	'family:box__decorator': {
		...
		'dark:peer-checked:bg-primary-600': true,
	...
	'family:text__inner': {
		...
		'focus-within:!ring-secondary-500': true,
	...
	'family:dropdown__listitem': {
		...
		'data-[is-active]:before:ring-secondary-500': true,
	...
	'family:dropdown__tagWrapper': {
		...
		'data-[active-selection=true]:ring-secondary-500': true,
	},
	...
	'range__input': {
		...
		'[&::-webkit-slider-thumb]:focus:!ring-secondary-500': true,
		...
		'[&::-moz-range-thumb]:focus:!ring-secondary-500': true,
	...
	'colorpicker__control': {
		...
		'focus-visible:ring-secondary-500': true,
	},
	...
	'colorpicker__swatch': {
		...
		'[&>canvas:focus-visible]:ring-secondary-500': true,
	...
	'toggle__track': {
		...
		'transition-all': true,
		'bg-neutral-400': true,
		'peer-checked:bg-primary-400': true,
		...
		'shadow-sm': true,
		'peer-focus-visible:ring-2': true,
		'peer-focus-visible:ring-secondary-500': true,
	...
	'transferlist__transferlist': {
		...
		'[&:has(:focus-visible)]:ring-secondary-500': true,
		'dark:border-neutral-600': true,
